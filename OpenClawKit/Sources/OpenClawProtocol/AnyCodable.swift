...
public struct AnyCodable: Codable, @unchecked Sendable, Hashable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        case let number as NSNumber:
            // Handle other NSNumber types (e.g., Decimal, Float) by converting to Double
        ...
        case let array as NSArray:
            try container.encode(array.map { AnyCodable($0) })
        default:
            // Fallback: convert unknown types to string representation to avoid encoding failure
