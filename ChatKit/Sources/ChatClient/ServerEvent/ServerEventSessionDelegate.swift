//
//  ServerEventSessionDelegate.swift
//  EventSource
//
...
/// Dedicated URLSession delegate for server-sent event streams.
final class ServerEventSessionDelegate: NSObject, URLSessionDataDelegate, @unchecked Sendable {
    enum Event {
